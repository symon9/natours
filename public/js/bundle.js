...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3ltb24wIiwiYSI6ImNseGM3amVlbDI3eTkybXNhaHN5b3Bvc2EifQ.Y1P5bxD8HT2kYT0EObEIMw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/symon0/clxc8k3dq02bk01pnhnl7fr8k'
    //   scrollZoom: false,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'https://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'https://127.0.0.1:3000/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
// DELEGATION
if (mapBox) {
  var _locations = JSON.parse(mapBox.dataset.locations);
}
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          document.getElementById('password-current').value = '', _readOnlyError("passwordCurrent");
